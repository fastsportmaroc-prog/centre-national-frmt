-- =============================================================================
-- PASSEPORTS & VISAS — à exécuter une fois dans Supabase → SQL Editor → Run
-- Projet : Centre National FRMT
-- =============================================================================
...
-- Bucket Storage (fichiers PDF / images)
...
-- Rechargement cache API Supabase (évite l’erreur "schema cache")
