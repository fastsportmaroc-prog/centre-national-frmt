-- Module Compétitions FRMT — nouvelles tables uniquement
-- Exécuter dans Supabase SQL Editor si la migration 034 n'est pas appliquée automatiquement.
...
create table if not exists public.competition_billets (
  ...
  aeroport_depart_iata text,
  aeroport_retour_iata text,
